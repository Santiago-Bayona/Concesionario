...
public class PickUpE extends VehiculoElectrico {
    ...
    public PickUpE(String codigo, String marca, boolean cuatrox4, String modelo, int numerobolsasAire, int numeropasajeros,
            int numeropuertas, boolean aireAcondionado, boolean camaraReversa, int numerobolsasaire, boolean ABS, double capacidadCajaCarga,co.edu.uniquindio.poo.Vehiculo.TipoTransmision tipoTransmision) {
