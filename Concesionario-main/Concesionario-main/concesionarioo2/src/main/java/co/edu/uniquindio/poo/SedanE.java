...
public class SedanE extends VehiculoElectrico {
    ...
    public SedanE(String codigo, String marca, boolean estado, String modelo, int cambios, int velocidadmaxima, int cilindraje,
            ...
            boolean sensoresTraficoCruzado, boolean asistenciaPermanenciaCarril, boolean aBS,co.edu.uniquindio.poo.Vehiculo.TipoTransmision tipoTransmision) {
