...
public class DeportivoE extends VehiculoElectrico{
    ...
    public DeportivoE(String codigo, String marca, boolean estado, String modelo, int cambios, int velocidadmaxima, int cilindraje,
                       String autonomiacargacompleta, int tiempopromediocarga, int numeropasajeros, int numeropuertas, int numerobolsasaire,
                       int caballosfuerza, int tiempo,co.edu.uniquindio.poo.Vehiculo.TipoTransmision tipoTransmision) {
