...
public class VanE extends VehiculoElectrico{
    ...
    public VanE(String placa, String marca, boolean estado, String modelo, int cambios, int velocidadmaxima, int cilindraje,
            String autonomiacargacompleta, int tiempopromediocarga, int numeropuertas, boolean aireAcondionado, boolean camaraReversa,
            int numeroBolsasAire, boolean ABS, double capacidadMaletero,co.edu.uniquindio.poo.Vehiculo.TipoTransmision tipoTransmision) {
