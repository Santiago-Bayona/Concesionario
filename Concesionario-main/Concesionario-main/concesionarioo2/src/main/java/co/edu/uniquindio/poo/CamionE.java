...
public class CamionE extends VehiculoElectrico {
    ...
    public CamionE(String codigo, String marca, boolean estado, String modelo, int cambios, int velocidadmaxima, int cilindraje,
            String autonomiacargacompleta, int tiempopromediocarga, double capacidadCarga, boolean frenosAire,
            boolean ABS, int numeroEjes,co.edu.uniquindio.poo.Vehiculo.TipoTransmision tipoTransmision) {
